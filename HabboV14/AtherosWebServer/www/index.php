...
<param name='src' value='http://127.0.0.1/v14/habbo.dcr'>
...
<?php } ?>
<param name='sw2' value='connection.info.host=127.0.0.1;connection.info.port=12321'>
<param name='sw4' value='connection.mus.host=127.0.0.1;connection.mus.port=12322'>
<param name='sw3' value='client.reload.url=http://127.0.0.1/'>
<param name='sw1' value='site.url=http://www.habbo.ch;url.prefix=http://www.habbo.ch'>
<param name='sw5' value='external.variables.txt=http://127.0.0.1/v14/external_vars.txt;external.texts.txt=http://127.0.0.1/v14/external_texts.txt'>
<embed src='http://127.0.0.1/v14/habbo.dcr' bgColor='#000000' width='720' height='540' swRemote='swSaveEnabled='true' swVolume='true' swRestart='false' swPausePlay='false' swFastForward='false' swTitle='Habbo Hotel' swContextMenu='true'' swStretchStyle='none' swText='' type='application/x-director' pluginspage='http://www.macromedia.com/shockwave/download/'
<?php if (isset($_GET['sso'])) { ?>
sw6='use.sso.ticket=1;sso.ticket=<?php echo $_GET['sso']; ?>'
<?php } ?>
sw2='connection.info.host=127.0.0.1;connection.info.port=12321'
sw4='connection.mus.host=127.0.0.1;connection.mus.port=12322'
sw3='client.reload.url=http://127.0.0.1/'
sw1='site.url=http://www.habbo.ch;url.prefix=http://www.habbo.co.uk'
sw5='external.variables.txt=http://127.0.0.1/v14/external_vars.txt;external.texts.txt=http://127.0.0.1/v14/external_texts.txt'></embed>
</object>
</div>
</body>
